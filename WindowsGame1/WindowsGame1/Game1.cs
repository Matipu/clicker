...
namespace WindowsGame1
{
    ...
    public class Game1 : Microsoft.Xna.Framework.Game
    {
        ...
        Rectangle rect;
        string[,] potwory = new string [,] { {"mob1","mob2", "anime_girl", "anime_girl2", "anime_girl3", "anime_girl4", "anime_girl5" },
            {"Lodowy golem","Wkurwiony golem","to","rak", "XDD", "chuj","sparky" } };
        string[] stages = new string[] { "tlo","tlo1" };
        ...
        public Game1(string arg)
        {
            ...
            if (arg == null)
            {
                Window.Title = "Jakiœ clicker";
            }
            else
            {
                Window.Title = "Jakiœ clicker " + arg;
                if (arg.Contains("testomde"))
                {
                    test = true;
                }
            }
        ...
        protected override void LoadContent()
        {
            ...
            potwor = Content.Load<Texture2D>("mob1");
            ...
            hp1 = Content.Load<Texture2D>("hp1");
